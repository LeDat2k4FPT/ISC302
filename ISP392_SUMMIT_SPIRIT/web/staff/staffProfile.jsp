        ...
        <main class="main-content">
            ...
            <div class="profile-form">
                ...
                <form action="<%= request.getContextPath()%>/MainController" method="POST">
                    ...
                    <div class="btn-group">
                        <a href="<%= request.getContextPath()%>/staff/staffDashboard.jsp" class="btn btn-outline">Cancel</a>                        <a href="<%= request.getContextPath()%>/changePassword.jsp" class="btn btn-secondary">Change Password</a>
